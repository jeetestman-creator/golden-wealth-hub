        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          <div className="glass-card rounded-2xl p-8 gold-border">
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-muted-foreground mt-1">Login to your Gold X USDT account</p>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleLogin}>
              ...
              <div className="relative">
                ...
                <Input type={showPassword ? "text" : "password"} placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 pr-10 bg-secondary border-border" required />
